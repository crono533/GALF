...
public:
  ...
  void check_pswd() {
    ...
    if (m_pswd_f_f == 2) {
      cout << "Flag: 53 69 42 65 61 72 73 7b 66 6c 61 67 5f 6e 65 5f 74 6f 74 "
              "7d";
    }
    if (m_pswd_f_f == 3) {
    ...
    if (m_pswd_f_f == 228337) {
      cout << "Flag: 01010011 01101001 01000010 01100101 01100001 01110010 "
              "01110011 01111011 01010110 00110100 01100100 01001001 01101101 "
              "01011111 01010011 01000101 01101101 01001001 01101110 01100001 "
              "01010010 01011111 01010010 01100101 01110110 01100101 01010010 "
              "01110011 01000001 01111101";
    }
    if (m_pswd_f_f == 123456789) {
      srand(time(NULL));
      int num = rand();
      int usernum = 0;
      cin >> usernum;
      if (num == usernum) {
        const char *f =
            "fx64LDGWiickPGLB+xnWHoQkLD1I+IhyeY1fMgQ6KjQtpkKJLG69jk/"
            "qLhT=TozJfhcbn41FgxHiLjQfAjJC";
        cout << f;
      }
    }
  }
...
int main(int argc, char const *argv[]) {
  ...
  char str[10] = {};
  cout << "Privet, try to ugadat' what pswd ya want from you!(pswd sostoit iz "
          "numbers)"
       << endl;
